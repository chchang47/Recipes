...
* Kali is currently eating one Ziploc bag of kibble (about 80g) with 1 tbsp of home-made wet food each meal. She eats a meal in the morning (anywhere between 7-9am) and at night (anywhere between 5-7pm).
...
* Kali does not have very good recall. She is very spotty at responding to `Come here` or `C'mere`! She will get excited and distracted by other dogs and animals such as lizards, squirrels, etc.
...
* In addition to her walks, we let Kali in the backyard first thing in the morning and in the evening after dinner. If we are home, we also let her play in the backyard in the afternoon (though if it is too hot, don't worry about that!).

### Snacks

* Kali enjoys small treats like breaking up the disc-shaped treats into smaller pieces.
* Kali enjoys eating:
